...
function getFallbackQuestions(siteSlug: string): string[] {
  ...
  'fx-vexx': ['Is forex trading legal in the UK?','What is the best FCA regulated forex broker 2026?','How to spot a forex scam broker?','What is ECN vs market maker broker?','Is leverage safe in forex trading?','What happens if my forex broker goes bankrupt?','How to verify a forex broker licence?','What is a prop trading firm and how do they work?','Which forex broker has the lowest spreads?','Is MetaTrader 4 or 5 better for beginners?','What is CFD trading and is it safe?','How to withdraw money from a forex broker?','What is ESMA regulation for forex?','Is eToro a good forex broker?','What is a PAMM account in forex?'],
  'trade-hub-iq': ['What is the best stock broker for beginners UK 2026?','How to open a stocks and shares ISA?','What is commission-free stock trading?','Is fractional shares investing safe?','How does options trading work for beginners?','What is the SIPC and does it protect my investments?','Which stock broker has the lowest fees 2026?','What is a Roth IRA and which broker is best?','How to choose a stock broker in 2026?','What is the difference between a broker and a fund?','Is day trading profitable for beginners?','What is ETF investing and how to start?','How to invest in dividends?','What is the FSCS protection limit?','Which trading app is best for stocks 2026?'],
  'jewish-news-now': ['What is happening in Israel today?','Is it safe to visit Israel in 2026?','How is Israel economy doing?','What is the Jewish Agency?','What is Birthright Israel?','What is life like in Tel Aviv?','What is Jerusalem known for?','Who are the main Israeli political parties?'],
  'jewish-property-report': ['How to buy property in Israel as a foreigner?','What is average apartment price in Tel Aviv 2026?','Is Israeli real estate a good investment?','What taxes apply to Israeli property for foreigners?','Can Americans buy property in Israel?','What is best area to buy in Tel Aviv?','How do I get an Israeli mortgage?','What is Tama 38 in Israel?'],
  'aliya-today': ['How do I make aliya to Israel?','What are benefits of making aliya?','How long does aliya process take?','What is Nefesh BNefesh?','What is Sal Klita?','How much Hebrew to make aliya?','What is best city in Israel for new olim?','What is an ulpan in Israel?'],

...
const SITE_PIPELINE = [
  // BATCH 1 — Day 1
  { domain:'signalboard.io',  slug:'signal-board',   name:'SignalBoard',     archetype:'dashboard', primary:'#7c3aed', font:'sans',  category:'Trading Signals', tagline:'Real-time market intelligence dashboard',
  ...
  { domain:'alphastream.co',  slug:'alpha-stream',   name:'AlphaStream',    archetype:'minimal',   primary:'#059669', font:'sans',  category:'Investment Alpha', tagline:'Alpha-generating ideas for serious investors',
  ...
  { domain:'capitalink.net',  slug:'capital-ink',    name:'CapitalInk',     archetype:'editorial', primary:'#0f172a', font:'serif', category:'Capital Markets', tagline:'The Capital Markets Journal',
  ...
  { domain:'fintelbyte.com',  slug:'fintel-byte',    name:'FintëlByte',     archetype:'tech',      primary:'#2563eb', font:'sans',  category:'Fintech & Data', tagline:'Where finance meets technology',
  ...
  { domain:'wealthpulse.io',  slug:'wealth-pulse',   name:'WealthPulse',    archetype:'magazine',  primary:'#dc2626', font:'sans',  category:'Wealth Management', tagline:'Premium intelligence for wealth builders',
  ...
  // BATCH 2 — Day 2
  { domain:'tradegrid.co',    slug:'trade-grid',     name:'TradeGrid',      archetype:'grid',      primary:'#0891b2', font:'sans',  category:'Global Trade', tagline:'Global trade intelligence in one grid',
  ...
  { domain:'marketrack.io',   slug:'marke-track',    name:'MarkeTrack',     archetype:'wire',      primary:'#7c2d12', font:'mono',  category:'Market Tracking', tagline:'Every move. Every market. Live.',
  ...
  { domain:'policyflow.co',   slug:'policy-flow',    name:'PolicyFlow',     archetype:'newspaper', primary:'#1e3a5f', font:'serif', category:'Policy & Regulation', tagline:'Financial policy that moves markets',
  ...
  { domain:'realdataiq.com',  slug:'real-data-iq',   name:'RealDataIQ',     archetype:'research',  primary:'#166534', font:'sans',  category:'Data Analysis', tagline:'Data-driven financial intelligence',
  ...
  { domain:'vaultpress.io',   slug:'vault-press',    name:'VaultPress',     archetype:'editorial', primary:'#4c1d95', font:'display',category:'Financial Media', tagline:'Journalism that holds finance accountable',
  ...
  // BATCH 3 — Day 3
  { domain:'fundwatch.co',    slug:'fund-watch',     name:'FundWatch',      archetype:'dashboard', primary:'#b45309', font:'sans',  category:'Fund Industry', tagline:'The fund industry intelligence platform',
  ...
  { domain:'quotelens.io',    slug:'quote-lens',     name:'QuoteLens',      archetype:'minimal',   primary:'#0e7490', font:'sans',  category:'Market Data', tagline:'Every price has a story',
  ...
  { domain:'debtwatch.co',    slug:'debt-watch',     name:'DebtWatch',      archetype:'research',  primary:'#991b1b', font:'sans',  category:'Fixed Income', tagline:'The fixed income intelligence hub',
  ...
  { domain:'mergermap.io',    slug:'merger-map',     name:'MergerMap',      archetype:'wire',      primary:'#1d4ed8', font:'sans',  category:'M&A Intelligence', tagline:'Every deal. Every detail. First.',
  ...
  { domain:'streetsense.co',  slug:'street-sense',   name:'StreetSense',    archetype:'tech',      primary:'#065f46', font:'sans',  category:'Wall Street Intel', tagline:'Street-level financial intelligence',
  ...
  // BATCH 4 — Day 4
  { domain:'globalfin.io',    slug:'global-fin',     name:'GlobalFin',      archetype:'magazine',  primary:'#7c3aed', font:'sans',  category:'Global Finance', tagline:'One world. One financial intelligence hub.',
  ...
  { domain:'riskpulse.co',    slug:'risk-pulse',     name:'RiskPulse',      archetype:'dashboard', primary:'#c2410c', font:'mono',  category:'Risk Management', tagline:'Quantify every risk before it finds you',
  ...
  { domain:'quarterlyiq.com', slug:'quarterly-iq',   name:'QuarterlyIQ',    archetype:'editorial', primary:'#0f4c81', font:'display',category:'Earnings Intelligence', tagline:'Earnings season intelligence',
  ...
  { domain:'creditdesk.io',   slug:'credit-desk',    name:'CreditDesk',     archetype:'newspaper', primary:'#374151', font:'serif', category:'Credit Markets', tagline:'Credit where credit is due',
  ...
  { domain:'fxreport.co',     slug:'fx-report',      name:'FX Report',      archetype:'wire',      primary:'#0369a1', font:'mono',  category:'Foreign Exchange', tagline:'FX intelligence from the desk',
  ...
  // BATCH 5 — Day 5
  { domain:'commodcore.io',   slug:'commod-core',    name:'CommodCore',     archetype:'grid',      primary:'#92400e', font:'sans',  category:'Commodities', tagline:'Raw commodity intelligence',
  ...
  { domain:'microwatch.co',   slug:'micro-watch',    name:'MicroWatch',     archetype:'minimal',   primary:'#4338ca', font:'sans',  category:'Micro-Cap Research', tagline:'Small cap. Big opportunity.',
  ...
  { domain:'techfloat.io',    slug:'tech-float',     name:'TechFloat',      archetype:'tech',      primary:'#0c4a6e', font:'sans',  category:'Tech Investing', tagline:'Technology sector investment intelligence',
  ...
  { domain:'pensioniq.co',    slug:'pension-iq',     name:'PensionIQ',      archetype:'research',  primary:'#134e4a', font:'serif', category:'Retirement Investing', tagline:'Intelligent retirement planning',
  ...
  { domain:'infrawatch.io',   slug:'infra-watch',    name:'InfraWatch',     archetype:'editorial', primary:'#1c1917', font:'sans',  category:'Infrastructure', tagline:'Infrastructure investment intelligence',
  ...
  // BATCH 6 — Day 6
  { domain:'earnbeat.co',     slug:'earn-beat',      name:'EarnBeat',       archetype:'wire',      primary:'#6d28d9', font:'sans',  category:'Earnings Beat', tagline:'Beat estimates. Beat the market.',
  ...
  { domain:'insideralpha.io', slug:'insider-alpha',  name:'InsiderAlpha',   archetype:'minimal',   primary:'#1d4ed8', font:'sans',  category:'Insider Intelligence', tagline:'Follow the smart money inside',
  ...
  { domain:'dividendco.net',  slug:'dividend-co',    name:'DividendCo',     archetype:'dashboard', primary:'#166534', font:'sans',  category:'Dividend Investing', tagline:'Build income. Build wealth.',
  ...
  { domain:'etfhub.co',       slug:'etf-hub',        name:'ETF Hub',        archetype:'grid',      primary:'#0891b2', font:'sans',  category:'ETF Intelligence', tagline:'Every ETF. Every flow. Every day.',
  ...
  { domain:'banknews.io',     slug:'bank-news',      name:'BankNews',       archetype:'newspaper', primary:'#1e3a8a', font:'serif', category:'Banking', tagline:'The banking industry newspaper',
  ...
  // BATCH 7 — Day 7
  { domain:'reitscore.co',    slug:'reit-score',     name:'REITScore',      archetype:'research',  primary:'#7e3af2', font:'sans',  category:'Real Estate', tagline:'REITs ranked. Real estate scored.',
  ...
  { domain:'biofinance.io',   slug:'bio-finance',    name:'BioFinance',     archetype:'tech',      primary:'#0f766e', font:'sans',  category:'Biotech Finance', tagline:'Where biotech meets capital',
  ...
  { domain:'climateiq.co',    slug:'climate-iq',     name:'ClimateIQ',      archetype:'editorial', primary:'#15803d', font:'display',category:'ESG & Climate', tagline:'Financial intelligence for a changing climate',
  ...
  { domain:'defiwatch.io',    slug:'defi-watch',     name:'DeFiWatch',      archetype:'dashboard', primary:'#6d28d9', font:'mono',  category:'DeFi & Web3', tagline:'Decentralized finance intelligence',
  ...
  { domain:'leverbyte.co',    slug:'lever-byte',     name:'LeverByte',      archetype:'magazine',  primary:'#b91c1c', font:'sans',  category:'Leveraged Finance', tagline:'Leveraged intelligence for leveraged positions',
  ...
  // BATCH 8 — Day 8  
  { domain:'yieldzone.io',    slug:'yield-zone',     name:'YieldZone',      archetype:'wire',      primary:'#0369a1', font:'mono',  category:'Yield Intelligence', tagline:'Find yield in any market',
  ...
  { domain:'spotdata.co',     slug:'spot-data',      name:'SpotData',       archetype:'minimal',   primary:'#334155', font:'sans',  category:'Spot Markets', tagline:'Real-time spot market intelligence',
  ...
  { domain:'regwatch.io',     slug:'reg-watch',      name:'RegWatch',       archetype:'research',  primary:'#1e3a8a', font:'sans',  category:'Regulation', tagline:'Regulatory intelligence before the market moves',
  ...
  { domain:'futurefund.co',   slug:'future-fund',    name:'FutureFund',     archetype:'editorial', primary:'#0f172a', font:'display',category:'Future of Finance', tagline:'Financing the future, today',
  ...
  { domain:'stratblock.io',   slug:'strat-block',    name:'StratBlock',     archetype:'grid',      primary:'#7c3aed', font:'sans',  category:'Strategies', tagline:'Every strategy. Ranked. Analyzed.',
  ...
  // BATCH 9 — Day 9
  { domain:'tradenest.co',    slug:'trade-nest',     name:'TradeNest',      archetype:'magazine',  primary:'#b45309', font:'sans',  category:'Trading Ideas', tagline:'Your nest for trading ideas',
  ...
  { domain:'execsignal.io',   slug:'exec-signal',    name:'ExecSignal',     archetype:'editorial', primary:'#1e40af', font:'display',category:'Executive Intelligence', tagline:'What executives are signaling',
  ...
  { domain:'corpwatch.co',    slug:'corp-watch',     name:'CorpWatch',      archetype:'newspaper', primary:'#374151', font:'serif', category:'Corporate Intelligence', tagline:'Watching corporations so you can invest wisely',
  ...
  { domain:'macropulse.io',   slug:'macro-pulse',    name:'MacroPulse',     archetype:'dashboard', primary:'#0c4a6e', font:'sans',  category:'Macro Economics', tagline:'The macroeconomic intelligence dashboard',
  ...
  { domain:'shortsell.co',    slug:'short-sell',     name:'ShortSell',      archetype:'wire',      primary:'#991b1b', font:'mono',  category:'Short Selling', tagline:'Borrowing conviction. Selling risk.',
  ...
  // BATCH 10 — Day 10
  { domain:'smallbizfin.io',  slug:'small-biz-fin',  name:'SmallBizFin',    archetype:'minimal',   primary:'#0891b2', font:'sans',  category:'SME Finance', tagline:'Financial intelligence for the small business owner',
  ...
  { domain:'cryptodesk.co',   slug:'crypto-desk',    name:'CryptoDesk',     archetype:'tech',      primary:'#f59e0b', font:'sans',  category:'Cryptocurrency', tagline:'The institutional crypto desk',
  ...
  { domain:'luxeinvest.io',   slug:'luxe-invest',    name:'LuxeInvest',     archetype:'editorial', primary:'#7c3aed', font:'display',category:'Luxury Assets', tagline:'Ultra-premium asset intelligence',
  ...
  { domain:'insurtech.co',    slug:'insur-tech',     name:'InsurTech',      archetype:'research',  primary:'#065f46', font:'sans',  category:'Insurance Technology', tagline:'Where insurance meets innovation',
  ...
  { domain:'ipo-board.io',    slug:'ipo-board',      name:'IPO Board',      archetype:'grid',      primary:'#1d4ed8', font:'sans',  category:'IPO Intelligence', tagline:'Every listing. Every valuation.',
  ...
  // BATCH 11 — Day 11
  { domain:'fixedinc.co',     slug:'fixed-inc',      name:'FixedInc',       archetype:'wire',      primary:'#374151', font:'mono',  category:'Fixed Income', tagline:'The fixed income wire service',
  ...
  { domain:'asiamarket.io',   slug:'asia-market',    name:'AsiaMarket',     archetype:'dashboard', primary:'#be123c', font:'sans',  category:'Asia Pacific', tagline:'Asia Pacific financial intelligence',
  ...
  { domain:'eurofin.co',      slug:'euro-fin',       name:'EuroFin',        archetype:'newspaper', primary:'#1e3a8a', font:'serif', category:'European Finance', tagline:'European financial journalism',
  ...
  { domain:'latamfin.io',     slug:'latam-fin',      name:'LatAmFin',       archetype:'magazine',  primary:'#92400e', font:'sans',  category:'Latin America', tagline:'Latin America financial intelligence',
  ...
  { domain:'menafinance.co',  slug:'mena-finance',   name:'MENAFinance',    archetype:'editorial', primary:'#0c4a6e', font:'display',category:'MENA Finance', tagline:'Middle East & North Africa financial intelligence',
  ...
  // BATCH 12 — Day 12  
  { domain:'hedgereport.io',  slug:'hedge-report',   name:'HedgeReport',    archetype:'research',  primary:'#4c1d95', font:'sans',  category:'Hedge Funds', tagline:'Inside the world of hedge funds',
  ...
  { domain:'optionflow.co',   slug:'option-flow',    name:'OptionFlow',     archetype:'wire',      primary:'#0f766e', font:'mono',  category:'Options Market', tagline:'See the flow. Trade with conviction.',
  ...
  { domain:'spotgold.io',     slug:'spot-gold',      name:'SpotGold',       archetype:'minimal',   primary:'#d97706', font:'sans',  category:'Precious Metals', tagline:'Gold intelligence. Pure and simple.',
  ...
  { domain:'techstox.co',     slug:'tech-stox',      name:'TechStox',       archetype:'tech',      primary:'#2563eb', font:'sans',  category:'Tech Stocks', tagline:'Tracking technology investments',
  ...
  { domain:'energyiq.io',     slug:'energy-iq',      name:'EnergyIQ',       archetype:'grid',      primary:'#15803d', font:'sans',  category:'Energy Finance', tagline:'Energy investment intelligence',

export const SITE_PODCAST_CONFIG: Record<string, {showName:string;hostName:string;hostRole:string;hostVoiceId:string;accentColor:string;bgColor:string;domain:string;tagline:string}> = {
  'global-trade-wire': { showName:'Nex-Wire Intelligence', hostName:'James Hart', hostRole:'Senior Markets Editor, Nex-Wire', hostVoiceId:'xMTIubkjc8KMDoYdz4bQ', accentColor:'#E03131', bgColor:'#0D0505', domain:'nex-wire.com', tagline:'Global Trade & Market Intelligence' },
  ...
  'business-pulse':    { showName:'Bizplezx Executive', hostName:'Daniel Sterling', hostRole:'Editorial Director, Bizplezx', hostVoiceId:'xMTIubkjc8KMDoYdz4bQ', accentColor:'#6741D9', bgColor:'#07031A', domain:'bizplezx.com', tagline:'Business Strategy & Innovation Intelligence' },
  ...
  'market-radar':      { showName:'Signalixx Radar', hostName:'Jordan Blake', hostRole:'Lead Signals Analyst, Signalix', hostVoiceId:'xMTIubkjc8KMDoYdz4bQ', accentColor:'#A61E4D', bgColor:'#0D0106', domain:'signalixx.com', tagline:'Market Signals & Technical Analysis' },
  'invest-data':       { showName:'InvexHuby Insights', hostName:'Michael Torres', hostRole:'Chief Investment Strategist', hostVoiceId:'xMTIubkjc8KMDoYdz4bQ', accentColor:'#0B6E4F', bgColor:'#011009', domain:'invexhuby.com', tagline:'Investment Intelligence & Fund Analysis' },
  'trust-score':       { showName:'Verivex Verified', hostName:'Nathan Chen', hostRole:'Head of Research, Verivex', hostVoiceId:'xMTIubkjc8KMDoYdz4bQ', accentColor:'#0CA678', bgColor:'#011209', domain:'verivex.co', tagline:'Verified Reviews & Broker Intelligence' },
  'executive-network': { showName:'Execvex Leadership', hostName:'Alexander Ross', hostRole:'Executive Editor, Execvex', hostVoiceId:'xMTIubkjc8KMDoYdz4bQ', accentColor:'#3B5BDB', bgColor:'#02031A', domain:'execvex.com', tagline:'Executive Leadership & Career Intelligence' },
}

...
const SITE_ABOUT: Record<string, {
  ...
  'copy-trade-iq':         { name:'CopyVexx', domain:'copyvexx.com', tagline:'Copy Trading Intelligence & Strategy', mission:'CopyVexx covers copy trading strategies, social trading platforms, and passive investment intelligence for traders who want to follow expert traders rather than trade manually. We analyse copy trading performance, risk metrics, platform comparisons, and portfolio building for the modern passive investor.', coverage:['Copy trading platform comparisons','Top trader performance analysis','Social trading risk management','Passive investing via copy portfolios','eToro, ZuluTrade and platform reviews'], editorial:'CopyVexx analyses publicly available performance data from copy trading platforms. All figures are sourced directly from platform statistics pages. We do not guarantee future performance of any copy trader.', founded:'2026', category:'Copy Trading & Social Investing' },
  'expat-invest-iq':       { name:'ExpatInvestIQ', domain:'expatinvestiq.com', tagline:'Expat Investment Intelligence Worldwide', mission:'ExpatInvestIQ publishes investment intelligence, tax planning guides, and wealth management analysis for expatriates and internationally mobile professionals. We cover offshore investing, expat tax obligations, multi-currency portfolios, and retirement planning for those living outside their home country.', coverage:['Expat investment platforms and accounts','International tax planning for expats','Offshore investment strategy','Multi-currency portfolio management','Expat retirement and pension planning'], editorial:'All tax information published by ExpatInvestIQ references official sources (HMRC, IRS, local tax authorities). Readers are advised to consult a qualified cross-border tax adviser before making investment or tax decisions.', founded:'2026', category:'Expat Finance & International Investment' },
}

...
function IanMarksBanner({ siteUrl }: { siteUrl: string }) {
  ...
  return (
    <a href={waUrl} target="_blank" rel="noopener noreferrer" style={{ display:'block', textDecoration:'none', marginBottom:16 }}>
      <div style={{
        background:'#fff',
        ...
        <div style={{ position:'relative', overflow:'hidden' }}>
          <img
            ...
            loading="lazy"
          />
          {/* WhatsApp CTA overlay at bottom */}
          <div style={{ padding:'10px 12px', background:'#fff', borderTop:'1px solid #e2e8f0' }}>
            <div style={{ background:'#25D366', color:'#fff', borderRadius:6, padding:'9px 12px', display:'flex', alignItems:'center', justifyContent:'center', gap:8, fontWeight:800, fontSize:12 }}>
  ...
  return (
    <div style={{ minHeight:'100vh', background:bg, fontFamily: false ? "'Inter',sans-serif" : '"Georgia","Times New Roman",serif', color:textPrimary }}>
      ...
      <div style={{ maxWidth:1400, margin:'0 auto', padding:'28px 20px' }}>
        {/* Ian Marks banner — left sticky column (Jewish sites only, desktop) */}
        <div style={{ display:'flex', gap:28, alignItems:'flex-start' }}>
          {isJewishSite && (
            <div className="ian-left" style={{ width:200, flexShrink:0, position:'sticky', top:110, alignSelf:'start' }}>
              <IanMarksBanner siteUrl={BASE} />
            </div>
          )}
          <div className="layout" style={{ flex:1, display:'grid', gridTemplateColumns:isJewishSite ? '1fr 300px' : '1fr 330px', gap:28 }}>
          ...
          <aside className="sidebar" style={{ position:'sticky', top:110, alignSelf:'start' }}>
            {/* IAN MARKS AD BANNER */}
            {isJewishSite && <IanMarksBanner siteUrl={BASE} />}
